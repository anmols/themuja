...
insert into `admin_accounts` (`id`, `user_name`, `password`, `series_id`, `remember_token`, `expires`, `admin_type`) values('4','superadmin','$2y$10$2TRnKl.IuyH8fF4tIwUY9.NrKeSl5MMlUcGtVuViV8htu8DrS2aRO','DJf6u76sLwu3CVpw','$2y$10$ltxNketjQ7xG.XjwoDIqAOB5TxlUr6QQdzAFqkf6y8UMIKWDHX0Ji','2018-12-21 15:17:46','super');
insert into `admin_accounts` (`id`, `user_name`, `password`, `series_id`, `remember_token`, `expires`, `admin_type`) values('5','admin','$2y$10$9bJUQsS3qm3pC2Iyn24egevAwB1KgiNXBYd4x716vIMaUb0j29Eiu',NULL,NULL,NULL,'admin');
